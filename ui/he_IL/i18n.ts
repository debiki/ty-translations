...
var t_he_IL: TalkyardTranslations = t = {
  ...
  Search: "חיפוש",
  SendMsg: "שליחת הודעה",
  ShowPreview: "תצוגה מקדימה",  // MISSING
  SignUp: "הצטרפות",
  Solution: "פתרון",
  started: "התחילה",
  Summary: "תקציר",
  ...
  You: "את", // female singular, if need plural female 'אתן', if need singular male: 'אתה' if plural male: 'אתם'
  you: "את",
  ...
  RegularMember: "חברה רגילה",  // MISSING renamed Regular Member —> Trusted Regular [RENREGLS]
  ...
  daysLtr: " ימים",      // days
  hoursLtr: " שעות",     // hours
  minsLtr: " דקות",      // minutes
  secsLtr: " שניות",      // seconds

  // Time ago, long text versions.
  daysAgo: (numDays: number) =>
    numDays === 1 ? "לפני יום" : `לפני ${numDays} ימים`,

  hoursAgo: (numHours: number) =>
    numHours === 1 ? "לפני שעה" : `לפני ${numHours} שעות`,

  minutesAgo: (numMins: number) =>
    numMins === 1 ? "לפני דקה" : `לפני ${numMins} דקות`,

  secondsAgo: (numSecs: number) =>
    numSecs === 1 ? "לפני שניה" : `לפני ${numSecs} שניות`,
